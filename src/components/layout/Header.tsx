...
export function Header() {
  ...
  // Trigger cart pulse animation when item added
  useEffect(() => {
    if (cartAnimationId > 0) {
      setCartPulse(true);
          ...
          <div className="flex items-center gap-1 md:gap-2">
            ...
            >
              <Button
                ...
                className={`relative w-9 h-9 md:w-10 md:h-10 rounded-full transition-colors ${
                  cartPulse 
                    ? 'text-[#C9A962] bg-[#C9A962]/10' 
                    : 'text-[#264348]/60 dark:text-white/50 hover:text-[#C9A962] dark:hover:text-[#C9A962] hover:bg-[#C9A962]/5'
                }`}
              >
